...
namespace Evertraxx{
  ...
  */
  public static class CamCommunicator{
    ...
    [DllImport("NUIY")]
    public static extern void SetCoef(float coef);
    [DllImport("NUIY")]
    public static extern void SetStab(int stab);
    [DllImport("NUIY")]
    public static extern void SetSens(int sens);
    [DllImport("NUIY")]
    public static extern void SetCountMin(int countMin);
    [DllImport("NUIY")]
    public static extern float GetCoef();
    [DllImport("NUIY")]
    public static extern int GetStab();
    [DllImport("NUIY")]
    public static extern int GetSens();
    [DllImport("NUIY")]
    public static extern int GetCountMin();
